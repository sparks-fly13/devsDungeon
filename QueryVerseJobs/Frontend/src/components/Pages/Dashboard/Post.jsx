...
function Post() {
  ...
  return (
    ...
    <div>
      <button type="submit"  className={` bg-green-500 text-white ${isMobile ? 'text-[4vw]' : 'text-[1.vw]'} font-serif font-semibold hover:bg-green-300 dark:bg-gradient-to-r from-orange-400 to-orange-600 p-[1vw] rounded-md flex justify-center mb-[10vw] mt-[2vw]`}  >Post the Job</button>
    </div>
    </form>
  )
}
