...
function CandidateProfile() {
  ...
  return (
    ...
    <form className='flex flex-col dark:text-slate-200' enctype="multipart/form-data" onSubmit={PersonalFormSubmitted}>
      ...
      <button type="submit" className='bg-green-500 hover:bg-green-300 dark:bg-gradient-to-r from-orange-400 to-orange-600 text-white font-serif font-medium p-[1vw] sm:text-[3vw] md:text-[1.5vw] max-w-[15vw] rounded-md m-[3vw] flex justify-center align-middle'>Save Details</button>
