  ...
  return (
    <>
      <div className={`flex justify-center align-middle bg-gray-300`}  >
        ...
        <div className={` right  max-h-[100vh] min-w-[100vw] sm:min-w-0 `}  >
          ...
          <div className={`flex font-serif  justify-evenly align-middle text-gray-700 p-[2vw] ${isMobile ? 'p-[5vw]' : ''} `}  >
            <div className={`${isMobile ? 'text-[3vw]' : 'text-[1vw]'} font-semibold dark:text-gray-300`}  >Don't have an account ?</div>
