            ...
            (selectedAvailability === 'Yes') ? (
              ...
              (userDetail.resume) ? (<button type="submit" className={`p-[1vw] relative ${isMobile ? 'left-[20vw]' : 'left-[40vw]'}  top-[2vh] bg-green-500 rounded font-bold text-white hover:bg-green-400 ${isMobile ? 'text-[4vw]' : 'text-[1vw]'}`} >Submit Application</button>) : (<>
                <NavLink to="/candidate/Dashboard/Profile">
                  <button type="submit" className={`p-[1vw] relative ${isMobile ? 'left-[20vw]' : 'left-[40vw]'}  top-[2vh] bg-green-500 dark:bg-gradient-to-r from-orange-400 to-orange-600 rounded font-bold text-white hover:bg-green-400 ${isMobile ? 'text-[4vw]' : 'text-[1vw]'}`} >Go To Profile</button>
                </NavLink>
              </>)
              ...
              <NavLink to="/jobs">
                <button type="submit" className={`p-[1vw] relative ${isMobile ? 'left-[20vw]' : 'left-[40vw]'}  top-[2vh] bg-green-500 dark:bg-gradient-to-r from-orange-400 to-orange-600 rounded font-bold text-white hover:bg-green-400 ${isMobile ? 'text-[4vw]' : 'text-[1vw]'}`} >Explore More</button>
              </NavLink>
